<template>
  <div class="dashboard-container">
      <el-button @click="showtrack" style="margin-left: 10px;margin-top: 10px">轨迹处理</el-button>
      <el-button @click="showplayback" style="margin-left: 10px;margin-top: 10px">轨迹回放</el-button>
      <el-button @click="showpoint" style="margin-left: 10px;margin-top: 10px">实时定位</el-button>
    <div id="myMap"></div>
  </div>
</template>
